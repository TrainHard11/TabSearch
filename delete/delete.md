...
What i want right now is to work on the F4 functionality, right now it opens a tab chrome://extensions/shortcuts it works great, but i wanna change it slightly, i want the functionality to look for any open tabs first of that
specific link , if there is one then go to that tab, if there isnt then sure create a new tab.

As solution give me the entire file content with all the changes included so i can simply copy and paste. If there are files which dont require any change dont even mention them.
...
```json
{
  ...
  "commands": {
    ...
    "custom_tab_1": {
      "description": "Custom Tab 1"
    },
    "custom_tab_2": {
      "description": "Custom Tab 2"
    },
    "custom_tab_3": {
      "description": "Custom Tab 3"
    },
    "custom_tab_4": {
      "description": "Custom Tab 4"
    },
    "custom_tab_5": {
      "description": "Custom Tab 5"
    },
    "custom_tab_6": {
      "description": "Custom Tab 6"
    },
    "custom_tab_7": {
      "description": "Custom Tab 7"
    },
    "move_tab_to_first": {
